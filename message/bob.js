...
case prefix + 'bass': 
    ...
    case prefix+'tupai':
                try {
                let set
                if (/bass/.test(q)) set = '-af equalizer=f=54:width_type=o:width=2:g=20'
                if (/blown/.test(q)) set = '-af acrusher=.1:1:64:0:log'
                if (/deep/.test(q)) set = '-af atempo=4/4,asetrate=44500*2/3'
                if (/earrape/.test(q)) set = '-af volume=12'
                if (/fast/.test(q)) set = '-filter:a "atempo=1.63,asetrate=44100"'
                if (/fat/.test(q)) set = '-filter:a "atempo=1.6,asetrate=22100"'
                if (/nightcore/.test(q)) set = '-filter:a atempo=1.06,asetrate=44100*1.25'
                if (/reverse/.test(q)) set = '-filter_complex "areverse"'
                if (/robot/.test(q)) set = '-filter_complex "afftfilt=real=\'hypot(re,im)*sin(0)\':imag=\'hypot(re,im)*cos(0)\':win_size=512:overlap=0.75"'
                if (/slow/.test(q)) set = '-filter:a "atempo=0.7,asetrate=44100"'
                if (/smooth/.test(q)) set = '-filter:v "minterpolate=\'mi_mode=mci:mc_mode=aobmc:vsbmc=1:fps=120\'"'
                if (/tupai/.test(q)) set = '-filter:a "atempo=0.5,asetrate=65100"'
                if (/audio/.test(mime)) {
                msg.reply(mess.wait)
                let mediap = await bob.downloadAndSaveMediaMessage(q)
                let ran = getRandom('.mp3')
                exec(`ffmpeg -i ${mediap} ${set} ${ran}`, (err, stderr, stdout) => {
            ...
            case prefix + 'creator':
                let vcard = 'BEGIN:VCARD\n' +
                    ...
                    'FN:PBZ463.\n' +
                    'ORG:Owner Bot;\n' +
                    'item1.TEL;type=CELL;type=VOICE;waid=628811929177:+62 881-1929-177\n' +
...
case prefix + 'nomerhoki': case prefix + 'nomorhoki': {
                if (!Number(q)) throw `Example : ${prefix + command} 6288292024190`
            ...
            case prefix + 'ramalanjodoh': case prefix + 'ramaljodoh': {
                if (!q) throw `Example : ${prefix + command} Dika, 7, 7, 2005, Novia, 16, 11, 2004`
            ...
            case prefix + 'artinama': {
                if (!q) throw `Example : ${prefix + command} Dika Ardianta`
            ...
            case prefix + 'kecocokannama': case prefix + 'cocoknama': {
                if (!q) throw `Example : ${prefix + command} Dika, 7, 7, 2005`
            ...
            case prefix + 'kecocokanpasangan': case prefix + 'cocokpasangan': case prefix + 'pasangan': {
                if (!q) throw `Example : ${prefix + command} Dika|Novia`
            ...
            case prefix + 'fengshui': {
                if (!q) throw `Example : ${prefix + command} Dika, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
if (isLimit(sender, isPremium, isOwner, limitCount, limit))
    return sendLimit()(_0xfd3b45(0x191) + _0xfd3b45(0x17e) + _0xfd3b45(0x186) + _0xfd3b45(0x182) + prefix + (_0xfd3b45(0x197) + _0xfd3b45(0x1a7) + _0xfd3b45(0x1a0) + _0xfd3b45(0x185) + _0xfd3b45(0x1a4) + _0xfd3b45(0x17c)));
...
anu = api1.instagramdlv2(`${opa}`).then(res => {
                ...
                case prefix+'ytmp3':
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return sendLimit()
if (!q) return reply(`Example : ${prefix + command} Link Nya`)
...
case prefix+'delsesiut':
      var _0x479e99=_0x5b5b;function _0x5b5b(_0x52dc2f,_0x5b4f08){var _0x3b894c=_0x3b89();return _0x5b5b=function(_0x5b5b17,_0x3c09a9){_0x5b5b17=_0x5b5b17-0x1c0;var _0x5c668e=_0x3b894c[_0x5b5b17];return _0x5c668e;},_0x5b5b(_0x52dc2f,_0x5b4f08);}(function(_0x39267f,_0x3d7cea){var _0x45676a=_0x5b5b,_0xdc7f58=_0x39267f();while(!![]){try{var _0xa4de3d=parseInt(_0x45676a(0x1c6))/0x1*(parseInt(_0x45676a(0x1cd))/0x2)+-parseInt(_0x45676a(0x1c0))/0x3*(-parseInt(_0x45676a(0x1ce))/0x4)+parseInt(_0x45676a(0x1c1))/0x5+-parseInt(_0x45676a(0x1cb))/0x6+-parseInt(_0x45676a(0x1c9))/0x7*(parseInt(_0x45676a(0x1c8))/0x8)+parseInt(_0x45676a(0x1cc))/0x9+parseInt(_0x45676a(0x1c7))/0xa*(-parseInt(_0x45676a(0x1ca))/0xb);if(_0xa4de3d===_0x3d7cea)break;else _0xdc7f58['push'](_0xdc7f58['shift']());}catch(_0x1d774b){_0xdc7f58['push'](_0xdc7f58['shift']());}}}(_0x3b89,0x9dfb7));var LoaD=await ReadJsonUT(from),nu='./storage_cabinets/D-B/ulartangga/'+from+_0x479e99(0x1c5);function _0x3b89(){var _0x136288=['2462730SnjclB','11436669zBfNpE','1456904snXwhz','20704PXhRTV','「\x20Success\x20」\x0a\x20History\x20Game\x20Sukses\x20Dihapus!!','69HpbkvC','1271755BTVoFE','then','unlinkSync','reply','.json','1iRfLSB','1462330MSJDVs','3116824FyuhZH','21mMuPQS','11dCSWjo'];_0x3b89=function(){return _0x136288;};return _0x3b89();}bob['DeleteMessage'](LoaD['key'],botNumber)[_0x479e99(0x1c2)](()=>{var _0x2f4f91=_0x479e99;msg[_0x2f4f91(0x1c4)](_0x2f4f91(0x1cf)),fs[_0x2f4f91(0x1c3)](nu);});
      break;         

case prefix+'ulartangga':
var _0x35932e=_0x4fab;(function(_0x451cd7,_0x9d18a2){var _0x256d76=_0x4fab,_0x565c28=_0x451cd7();while(!![]){try{var _0x41d559=-parseInt(_0x256d76(0x1e6))/0x1*(parseInt(_0x256d76(0x1f8))/0x2)+-parseInt(_0x256d76(0x1f9))/0x3+-parseInt(_0x256d76(0x1f3))/0x4+parseInt(_0x256d76(0x1f7))/0x5*(parseInt(_0x256d76(0x1ee))/0x6)+parseInt(_0x256d76(0x1f5))/0x7+parseInt(_0x256d76(0x1ec))/0x8+parseInt(_0x256d76(0x1e5))/0x9*(-parseInt(_0x256d76(0x1f1))/0xa);if(_0x41d559===_0x9d18a2)break;else _0x565c28['push'](_0x565c28['shift']());}catch(_0x23b105){_0x565c28['push'](_0x565c28['shift']());}}}(_0x54c4,0x37251));if(!isGroup)return msg[_0x35932e(0x1fd)](_0x35932e(0x1fc));if(isGame(sender,isOwner,gcount,glimit))return reply(_0x35932e(0x200));if(fs[_0x35932e(0x1ef)](_0x35932e(0x1fe)+from+_0x35932e(0x1fb)))return msg[_0x35932e(0x1fd)](_0x35932e(0x1e8)+prefix+_0x35932e(0x1e7));function _0x54c4(){var _0xa704dc=['\x20Mengajak\x20@','5274KfeAUp','existsSync','https://telegra.ph/file/265c672094dfa87caea19.jpg','210VnBYHh','split','116796fSHkIb','.jpg','3107909JZLEDm','@s.whatsapp.net','1760PpCKIF','125148SOXquE','1039344TNXkVf','stringify','.json','*𝗙𝗜𝗧𝗨𝗥\x20𝗗𝗜\x20𝗧𝗢𝗟𝗔𝗞*\x20〄\x0a\x20Fitur\x20ini\x20Hanya\x20bisa\x20di\x20Akses\x20Di\x20Group\x20!','reply','./storage_cabinets/D-B/ulartangga/','Sad\x20amat\x20main\x20sama\x20bot\x20🗿','Limit\x20game\x20kamu\x20sudah\x20habis','message','./storage_cabinets/image/','profilePictureUrl','sender','\x20untuk\x20bermain\x20🐍\x20ulartangga\x20bersama\x0a\x0aKetik\x20:\x20Y\x20[\x20Untuk\x20Menyetujui]\x0aKetik\x20:\x20N\x20[\x20Untuk\x20Menolak\x20]\x0a\x0a[❗]\x20*PERINGATAN*\x0aIngat,\x20bermainlah\x20dengan\x20sportif\x20dan\x20jangan\x20melakukan\x20spam\x20secara\x20bergantian\x20dalam\x20waktu\x20yang\x20singkat!,\x0aBeri\x20jeda\x20minimal\x203\x20detik\x20agar\x20tidak\x20terjadi\x20kecacatan\x20dalam\x20game!!','image','120429qBZqKX','5BNxJvI','delsesiut*\x20untuk\x20menghapus\x20history\x20permainan\x20anda','「\x20Anda\x20masih\x20dalam\x20permainan!!\x20」\x0asilahkan\x20ketik\x20*','https://telegra.ph/file/42d2a0e0881e349806028.jpg','extendedTextMessage','Sad\x20amat\x20main\x20ama\x20diri\x20sendiri','3535968QQiVnB'];_0x54c4=function(){return _0xa704dc;};return _0x54c4();}if(msg[_0x35932e(0x201)]['extendedTextMessage']===undefined||msg[_0x35932e(0x201)][_0x35932e(0x1ea)]===null)return msg[_0x35932e(0x1fd)]('Tag\x20orang\x20yang\x20ingin\x20kamu\x20ajak\x20bermain!!');if(mentionByTag[0x0]===botNumber)return msg[_0x35932e(0x1fd)](_0x35932e(0x1ff));if(mentionByTag[0x0]===sender)return msg[_0x35932e(0x1fd)](_0x35932e(0x1eb));let PL=mentionByTag[0x0]?mentionByTag[0x0]:mentionByreply?mentionByreply:q['replace'](new RegExp('[()+-/\x20+/]','gi'),'')+_0x35932e(0x1f6);function _0x4fab(_0x32eedf,_0x4deeee){var _0x54c4ef=_0x54c4();return _0x4fab=function(_0x4fab6e,_0x742b0d){_0x4fab6e=_0x4fab6e-0x1e4;var _0x476d44=_0x54c4ef[_0x4fab6e];return _0x476d44;},_0x4fab(_0x32eedf,_0x4deeee);}var playersUT1=msg[_0x35932e(0x204)],playersUT2=PL,ID_UT=from,turnUT=playersUT2;try{var ppus1=await bob[_0x35932e(0x203)](msg[_0x35932e(0x204)],_0x35932e(0x1e4));}catch{ppus1=_0x35932e(0x1e9);}try{var ppus2=await bob[_0x35932e(0x203)](PL,_0x35932e(0x1e4));}catch{ppus2=_0x35932e(0x1f0);}let resz1=await reSize(ppus1,0x22,0x22),resz2=await reSize(ppus2,0x22,0x22);var randpic1=await getRandom(_0x35932e(0x1f4)),randpic2=await getRandom(_0x35932e(0x1f4)),randTemp=await getRandom(_0x35932e(0x1f4));await fs['writeFileSync'](_0x35932e(0x202)+randpic1,resz1),await fs['writeFileSync'](_0x35932e(0x202)+randpic2,resz2);const pic1='./storage_cabinets/image/'+randpic1,pic2='./storage_cabinets/image/'+randpic2,templatePath=_0x35932e(0x202)+randTemp;var sesi={'gilir':0x0,'key':[],'template':templatePath,'player1':{'id':playersUT1,'jalan':0x1,'picture':pic1},'player2':{'id':playersUT2,'setuju':![],'jalan':0x1,'picture':pic2}};fs['writeFileSync'](_0x35932e(0x1fe)+from+_0x35932e(0x1fb),JSON[_0x35932e(0x1fa)](sesi,null,0x2)),bob['sendMessage'](from,{'text':'\x20@'+msg['sender'][_0x35932e(0x1f2)]('@')[0x0]+_0x35932e(0x1ed)+PL['split']('@')[0x0]+_0x35932e(0x205),'mentions':[PL,msg[_0x35932e(0x204)]]},{'quoted':nay1}),gameAdd(sender,glimit);
      break;
